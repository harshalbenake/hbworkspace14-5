package com.elitetechnologies.eventcalender.vertical;
...
public class VerticalCalenderActivity extends AppCompatActivity implements CalendarPickerController {

    private static final String LOG_TAG = VerticalCalenderActivity.class.getSimpleName();
    Toolbar mToolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_vertical_calender);
